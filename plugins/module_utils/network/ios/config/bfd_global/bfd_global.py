...
"""
The ios_bfd_global config file.
...
class Bfd_global(ResourceModule):
    """
    The ios_bfd_global config class
    """

    def __init__(self, module):
        super(Bfd_global, self).__init__(
            empty_fact_val={},
            facts_module=Facts(module),
            module=module,
            resource="bfd_global",
            tmplt=Bfd_globalTemplate(),
        )
        self.parsers = []
    ...
    def _compare(self, want, have):
        ...
        for the Bfd_global network resource.
        """
