...
"""
The ios_vlan_configurations config file.
...
class Vlan_configurations(ResourceModule):
    """
    The ios_vlan_configurations config class
    """

    def __init__(self, module):
        super(Vlan_configurations, self).__init__(
            empty_fact_val={},
