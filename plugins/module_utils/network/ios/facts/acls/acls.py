...
class AclsFacts(object):
    ...
    def populate_facts(self, connection, ansible_facts, data=None):
        ...
        rmmod = NetworkTemplate(
            lines=data.splitlines(), tmplt=AclsTemplate()
        )
        q(rmmod)
        current = rmmod.parse()
    ...
    #             if (
    #                 temp == access_list_name
    #                 and "access-list" in each
    #                 and not (
    #                     "extended" in access_list_name
    #                     or "standard" in access_list_name
    #                 )
    #             ):
    ...
    #                     if (
    #                         source_index + 2
    #                     ) == index and "ipv6" not in each_list:
    ...
    #                 if "any" in each:
    #                     if each.index("any") > each.index(
    #                         ip_n_wildcard_bits[0]
    #                     ):
    #                         source["address"] = ip_n_wildcard_bits[0]
    #                         source["wildcard_bits"] = ip_n_wildcard_bits[1]
    #                         destination["any"] = True
    #                     elif each.index("any") < each.index(
    #                         ip_n_wildcard_bits[0]
    #                     ):
    #                         source["any"] = True
    #                         destination["address"] = ip_n_wildcard_bits[0]
    #                         destination["wildcard_bits"] = ip_n_wildcard_bits[
    #                             1
    #                         ]
    #                 else:
    #                     source["address"] = ip_n_wildcard_bits[0]
    ...
    #         temp_config.extend(
    #             [grant + item for item in temp if "access-list" not in item]
    #         )
    ...
    #                     ace_options["sequence"] = int(
    #                         each_list[each_list.index("sequence") + 1]
    #                     )
    #         except ValueError:
    #             pass
    ...
    #             if (
    #                 option in each_list
    #                 and "access" not in each_list[each_list.index(option) + 1]
    #             ):
    #                 temp_option = option
    ...
    #                     temp_flag = [
    #                         each_flag
    #                         for each_flag in tcp_flags
    #                         if each_flag in each
    #                     ]
    #                     if temp_flag:
    #                         flag = temp_flag[0]
    ...
    #                     temp_flag = [
    #                         each_option
    #                         for each_option in igmp_options
    #                         if each_option in each
    #                     ]
    #                     if temp_flag:
    #                         flag = temp_flag[0]
    ...
    #             each_list = [
    #                 item for item in each_list[: each_list.index("ttl")]
    #             ]
    #             ace_options["ttl"] = ttl
