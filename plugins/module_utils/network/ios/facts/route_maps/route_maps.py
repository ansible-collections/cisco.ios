                    ...
                    if val["entries"].get("match"):
                        if val["entries"]["match"].get("local_preference"):
                            ...
                            if local_preference_val:
                                ...
                                val["entries"]["match"]["local_preference"][
                                    "value"
                                ] = local_preference_val
                        ...
                        if val["entries"]["match"].get("security_group"):
                            if val["entries"]["match"]["security_group"].get(
                                "source"
                            ):
                                source = [
                                    each
                                ...
                                if source:
                                    ...
                                    val["entries"]["match"]["security_group"][
                                        "source"
                                    ] = source
                            if val["entries"]["match"]["security_group"].get(
                                "destination"
                                ...
                                if destination:
                                    if isinstance(destination[0], str):
                                        val["entries"]["match"][
                                            ...
                                            int(each)
                                            for each in destination[0].split(
                                                " "
                                            )
                                        ]
                                    else:
                        ...
                        if val["entries"]["match"].get("as_path"):
                            val["entries"]["match"]["as_path"]["acl"] = val[
                                "entries"
                            ]["match"]["as_path"]["acl"].split(" ")
                        if val["entries"]["match"].get("ip"):
                            for k_ip, v_ip in iteritems(
                                ...
                                if v_ip["prefix_list"]:
                                    v_ip["prefix_list"] = v_ip["prefix_list"][
                                        0
                                    ].split(" ")
