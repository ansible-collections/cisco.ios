...
def is_valid_ipv4(ip_str):
    return (
        True if re.match(r"(?:[0-9]{1,3}\.){3}[0-9]{1,3}", ip_str) else False
    )


def is_valid_ipv6(ip_str):
    match_exp = r"(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|\
                                                ...
                                                (2[0-4]|1{0,1}[0-9]){0,1}[0-9])|\
                                                    ([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|\
                                                        (2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|\
                                                            1{0,1}[0-9]){0,1}[0-9]))\S+"
    return True if re.match(match_exp, ip_str) else False
