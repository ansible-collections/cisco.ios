...
"""
The module file for ios_bfd_static_global
"""
...
from ansible_collections.cisco.ios.plugins.module_utils.network.ios.config.bfd_static_global.bfd_static_global import (
    Bfd_static_global,
)
...
def main():
    ...
    module = AnsibleModule(
        argument_spec=Bfd_static_globalArgs.argument_spec,
    ...
    result = Bfd_static_global(module).execute_module()
