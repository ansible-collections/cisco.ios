...
from ansible_collections.bentest.ios.plugins.module_utils.network.ios.argspec.ping.ping import (
    PingArgs,
)
from ansible_collections.bentest.ios.plugins.module_utils.network.ios.config.ping.ping import Ping
