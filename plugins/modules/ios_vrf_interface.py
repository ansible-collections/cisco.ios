...
"""
The module file for ios_vrf_interface
"""
...
from ansible_collections.cisco.ios.plugins.module_utils.network.ios.config.vrf_interface.vrf_interface import (
    Vrf_interface,
)
...
def main():
    ...
    module = AnsibleModule(
        argument_spec=Vrf_interfaceArgs.argument_spec,
    ...
    result = Vrf_interface(module).execute_module()
