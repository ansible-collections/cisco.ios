...
from ansible_collections.bentest.ios.plugins.modules import ios_acl_interfaces
...
class TestIosAclInterfacesModule(TestIosModule):
    ...
    def setUp(self):
        ...
        self.mock_execute_show_command = patch(
            "ansible_collections.bentest.ios.plugins.module_utils.network.ios.facts.acl_interfaces.acl_interfaces."
