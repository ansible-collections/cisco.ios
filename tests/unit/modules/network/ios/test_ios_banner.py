...
class TestIosBannerModule(TestIosModule):
    ...
    def setUp(self):
        ...
        self.mock_exec_command = patch(
            "ansible_collections.cisco.ios.plugins.modules.ios_banner.exec_command"
        )
    ...
    def load_fixtures(self, commands=None):
        self.exec_command.return_value = (
            0,
            load_fixture("ios_banner_show_banner.txt").strip(),
            None,
        )
...
class TestIosBannerIos12Module(TestIosBannerModule):
    def load_fixtures(self, commands):
        ...
        show_running_config_return_value = (
            0,
            load_fixture("ios_banner_show_running_config_ios12.txt").strip(),
            None,
        )
        self.exec_command.side_effect = [
            show_banner_return_value,
            show_running_config_return_value,
        ]
