...
from ansible_collections.bentest.ios.plugins.modules import ios_bgp_global
from ansible_collections.bentest.ios.tests.unit.compat.mock import patch
from ansible_collections.bentest.ios.tests.unit.modules.utils import AnsibleFailJson, set_module_args
...
class TestIosBgpGlobalModule(TestIosModule):
    ...
    def setUp(self):
        ...
        self.mock_execute_show_command = patch(
            "ansible_collections.bentest.ios.plugins.module_utils.network.ios.facts.bgp_global.bgp_global."
