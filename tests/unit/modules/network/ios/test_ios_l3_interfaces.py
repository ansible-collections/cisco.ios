...
from ansible_collections.bentest.ios.plugins.modules import ios_l3_interfaces
...
class TestIosL3InterfacesModule(TestIosModule):
    ...
    def setUp(self):
        ...
        self.mock_execute_show_command = patch(
            "ansible_collections.bentest.ios.plugins.module_utils.network.ios.facts.l3_interfaces.l3_interfaces."
