...
from ansible_collections.bentest.ios.plugins.modules import ios_lag_interfaces
...
class TestIosLagInterfacesModule(TestIosModule):
    ...
    def setUp(self):
        ...
        self.mock_execute_show_command = patch(
            "ansible_collections.bentest.ios.plugins.module_utils.network.ios.facts.lag_interfaces.lag_interfaces."
