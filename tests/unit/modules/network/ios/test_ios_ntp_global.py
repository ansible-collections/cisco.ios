...
from ansible_collections.bentest.ios.plugins.modules import ios_ntp_global
...
class TestIosNtpGlobalModule(TestIosModule):
    ...
    def setUp(self):
        ...
        self.mock_execute_show_command = patch(
            "ansible_collections.bentest.ios.plugins.module_utils.network.ios.facts.ntp_global.ntp_global."
