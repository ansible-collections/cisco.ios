...
from ansible_collections.bentest.ios.plugins.modules import ios_ospfv3
...
class TestIosOspfV3Module(TestIosModule):
    ...
    def setUp(self):
        ...
        self.mock_execute_show_command = patch(
            "ansible_collections.bentest.ios.plugins.module_utils.network.ios.facts.ospfv3.ospfv3."
