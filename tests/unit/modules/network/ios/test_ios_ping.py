...
from ansible_collections.bentest.ios.plugins.modules import ios_ping
...
class TestIosPingModule(TestIosModule):
    ...
    def setUp(self):
        ...
        self.mock_execute_show_command = patch(
            "ansible_collections.bentest.ios.plugins.module_utils.network.ios.config.ping.ping.Ping.run_command",
        )
