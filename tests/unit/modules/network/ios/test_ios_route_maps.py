...
from ansible_collections.bentest.ios.plugins.modules import ios_route_maps
...
class TestIosRouteMapsModule(TestIosModule):
    ...
    def setUp(self):
        ...
        self.mock_execute_show_command = patch(
            "ansible_collections.bentest.ios.plugins.module_utils.network.ios.facts.route_maps.route_maps."
