...
from ansible_collections.bentest.ios.plugins.modules import ios_snmp_server
...
class TestIosSnmpServerModule(TestIosModule):
    ...
    def setUp(self):
        ...
        self.mock_execute_show_command = patch(
            "ansible_collections.bentest.ios.plugins.module_utils.network.ios.facts.snmp_server.snmp_server."
