...
class TestIosVrfModule(TestIosModule):
    ...
    def test_ios_vrf_state_absent(self):
        set_module_args({"name": "test_1", "state": "absent"})
    ...
    def test_ios_vrf_purge_all_but_one(self):
        set_module_args({"name": "test_1", "purge": True})
        commands = [
            "no vrf definition test_2",
            "no vrf definition test_3",
            "no vrf definition test_17",
    ...
    def test_ios_vrfs_no_purge(self):
        ...
        set_module_args({"vrfs": vrfs})
        commands = ["vrf definition test_4"]
        self.execute_module(changed=True, commands=commands)

    def test_ios_vrfs_purge(self):
        vrfs = [{"name": "test_1"}, {"name": "test_4"}]
        set_module_args({"vrfs": vrfs, "purge": True})
        commands = [
    ...
    def test_ios_vrfs_global_arg(self):
        ...
        set_module_args({"vrfs": vrfs, "description": "test string"})
        commands = [
    ...
    def test_ios_vrf_route_both(self):
        set_module_args({"name": "test_5", "rd": "2:100", "route_both": ["2:100", "3:100"]})
        commands = [
    ...
    def test_ios_vrf_route_import(self):
        set_module_args({"name": "test_6", "rd": "3:100", "route_import": ["3:100", "4:100"]})
        commands = [
    ...
    def test_ios_vrf_route_export(self):
        set_module_args({"name": "test_7", "rd": "4:100", "route_export": ["3:100", "4:100"]})
        commands = [
    ...
    def test_ios_vrf_route_both_ipv4(self):
        set_module_args(
            {"name": "test_9", "rd": "168.0.0.9:100", "route_both_ipv4": ["168.0.0.9:100", "3:100"]},
        )
        commands = [
    ...
    def test_ios_vrf_route_import_ipv6(self):
        set_module_args(
            {"name": "test_14", "rd": "3:100", "route_import_ipv6": ["3:100", "168.0.0.14:100"]},
        )
        commands = [
    ...
    def test_ios_vrf_route_export_ipv6(self):
        set_module_args(
            {"name": "test_15", "rd": "4:100", "route_export_ipv6": ["168.0.0.15:100", "4:100"]},
        )
        commands = [
    ...
    def test_ios_vrf_interface_brownfield(self):
        set_module_args({"name": "test_19", "interfaces": ["Ethernet1"]})
